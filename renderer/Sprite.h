...
public:
    ...
    Sprite(const std::string& vs_path, const std::string& fs_path, const std::string& image_path, SpriteShape shape = SpriteShape::kRect, Projection proj = Projection::kPerspective);
    ~Sprite();
